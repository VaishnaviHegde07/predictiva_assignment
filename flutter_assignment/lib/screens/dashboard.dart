...
import 'package:flutter_assignment/utils/custom_container.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void fetchDashboardData() async {
    ...
    await Future.wait([
      dashboardController.getPortfolios(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Container(
              height: screenHeight * 0.08, color: ColorPalette.appbarColor),
          Padding(
            padding:
            ...
            child: Column(
              ...
              children: <Widget>[
                HeadingText(text: 'Hi Robin,', fontSize: screenHeight * 0.030),
  ...
  Widget showPortfolios(BuildContext context, DashboardController records) {
    ...
    return records.getPortfolioLoader || records.getAllPortfolios().data == null
        ...
        : Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: ColorPalette.containerBackground, width: 2)),
            child: Column(
  ...
  Widget showOrders(BuildContext context, DashboardController records) {
    ...
    return records.getOrderLoader || records.getAllOrdersRecords().data == null
        ? const Center(child: CircularProgressIndicator())
        : Container(
            height: screenHeight,
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: ColorPalette.containerBackground, width: 2.0)),
            child: Padding(
              padding:
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: screenHeight * 0.01),
                        records.currentPageOrders.isEmpty
                            ? Center(
                                heightFactor: 10,
                                child: HeadingText(
                            ...
                            : SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    var order =
                                        records.currentPageOrders[index];
                                    return Column(
                                      children: [
                                        const Divider(
                                            color: ColorPalette
                            ...
                            : Row(
                                ...
                                children: [
                                  CommonText(
                                    ...
                                    color: ColorPalette.pageNoColor,
                                  ),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    crossAxisAlignment:
